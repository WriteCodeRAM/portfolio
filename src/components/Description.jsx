...
function Description() {
  ...
  const repos = {
    ...
    currently: {
      ...
      border: "react-border",
      description:
        "The goal of this project is to get some more experience with web sockets/socket.io and nextJS by creating a multiplayer game where players can guess which celebrity is behind a blurred tweet displayed on their screen.",
      img1: "/twesser.png",
      href1: "https://github.com/WriteCodeRAM/Twesser",
    },
  };
  ...
  return (
    <div className="description-container">
      ...
      <p className="graduation">
        ...
        <span className="react" onClick={() => handleSpanClick("currently")}>
          Twesser
        </span>
      </p>
